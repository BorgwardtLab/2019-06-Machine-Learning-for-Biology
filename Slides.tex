...
\begin{document}
  ...
  \begin{frame}
    \begin{block}{Machine learning needs clear objectives}
    ...
    \vfill
    %
    What should an ``ideal'' algorithm do for \emph{your} project?
  \end{frame}

  \begin{frame}
    \begin{block}{Machine learning needs a hypothesis}
    ...
    \vfill
    %
    The results of a machine learning algorithm should be able to
    surprise you~(because a hypothesis has been disproved).
  \end{frame}

  \begin{frame}
    \begin{block}{Machine learning cannot extract something from nothing}
